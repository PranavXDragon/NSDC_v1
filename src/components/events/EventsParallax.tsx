  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Blue Tint Overlay */}
        <div className="absolute inset-0 bg-nsdc-blue/10 mix-blend-overlay" />
      ...
      >
        ...
        >
          <span className="w-8 h-px bg-nsdc-blue/40" />
          <span
        ...
        >
          EXPERIENCES THAT
          <br />
          <span className="text-transparent bg-clip-text bg-linear-to-r from-nsdc-blue via-cyan-400 to-nsdc-blue">
            TRANSFORM
          </span>
        </motion.h2>
