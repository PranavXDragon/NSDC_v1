    ...
    >
      <Link href={`/events/${event.slug}`}>
        <div
          ...
          } gap-8 md:gap-12 p-6 md:p-10 bg-[var(--surface)] border border-white/5 hover:border-nsdc-blue/20 transition-all duration-500`}
        >
          {/* Corner Accents */}
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            {/* Title */}
            <h3
              className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-black text-[var(--foreground)] mb-3 group-hover:text-nsdc-blue transition-colors leading-tight"
          ...
          >
            <ArrowUpRight className="w-5 h-5 text-nsdc-blue" />
          </motion.div>

          {/* Featured Badge */}
          {event.isFeatured && (
            <div className="absolute -top-3 left-8 px-3 py-1 bg-nsdc-blue/20 border border-nsdc-blue/30 rounded-full">
              <span
                className="text-[9px] font-semibold tracking-wider text-nsdc-blue uppercase flex items-center gap-1.5"
                style={{ fontFamily: "var(--font-body)" }}
              >
                <span className="w-1.5 h-1.5 bg-nsdc-blue rounded-full" />
                Featured
              </span>
            </div>
          )}
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-6">
            <h2
              ...
              style={{ fontFamily: "var(--font-heading)" }}
            >
              THE FIRST <span className="text-nsdc-blue">STEPS</span>
            </h2>
          ...
          <p
            ...
            style={{ fontFamily: "var(--font-body)" }}
          >
            Our chapter is just getting started. These are the first events, workshops, and initiatives that will shape the NSDC SCET journey.
          </p>
        </motion.div>
