      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        ...
        >
          <div className="max-w-[1400px] mx-auto w-full">
            ...
            >
              <strong className="text-[var(--foreground)] font-bold">LEARN. BUILD. COMPETE. CONNECT.</strong>
              <br />
              Workshops, challenges, hackathons, and community experiences — built for students, by students.
            </motion.p>
