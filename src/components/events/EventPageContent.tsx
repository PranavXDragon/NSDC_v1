...
export default function EventPageContent({ event }: EventPageContentProps) {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-[#030303]">
      {/* Progress Bar */}
      <motion.div
        className="fixed top-0 left-0 right-0 h-[2px] bg-nsdc-blue z-[200] origin-left"
      ...
      <section ref={heroRef} className="relative min-h-screen overflow-hidden">
        ...
        >
          ...
          />
          <motion.div
            className="absolute bottom-[20%] right-[15%] w-16 h-16 border border-nsdc-blue/10 rounded-full"
            ...
            {(hasPreview || event.image || slideshowImages.length > 0) ? (
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  ...
                  <div className="absolute -bottom-4 -left-4 w-8 h-8 border-b border-l border-nsdc-blue/30" />
                </motion.div>
                      ...
                      {event.registrationUrl && event.registrationUrl !== "#" ? (
                        <Link href={event.registrationUrl}>
                          <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            className="inline-flex items-center gap-3 px-8 py-4 bg-nsdc-blue text-[var(--foreground)] font-semibold rounded-full hover:bg-nsdc-blue/90 transition-colors"
                          >
          ...
          >
            ...
            >
              <motion.div
                className="w-1 h-2 bg-nsdc-blue/60 rounded-full"
                animate={{ y: [0, 8, 0] }}
          ...
          <ContentSection title="Highlights" icon={Sparkles}>
            <div className="grid md:grid-cols-2 gap-4">
              {event.highlights.map((highlight, i) => (
                ...
                >
                  <span className="w-1.5 h-1.5 mt-2 bg-nsdc-blue rounded-full shrink-0" />
                  <span
                ...
                {event.schedule.map((item, i) => (
                  ...
                  >
                    <div className="w-24 shrink-0">
                      <span
                        className="text-xs font-semibold text-nsdc-blue"
                        style={{ fontFamily: "var(--font-body)" }}
                      >
                        {item.time}
                      </span>
                ...
                {event.speakers.map((speaker, i) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-full bg-linear-to-br from-nsdc-blue/20 to-transparent border border-nsdc-blue/20 flex items-center justify-center">
                        <Users className="w-5 h-5 text-nsdc-blue/60" />
                      </div>
                      <div>
                        <h4
                          className="text-sm font-semibold text-white/80"
                ...
                {event.links.map((link, i) => (
                  <Link key={i} href={link.url} target="_blank" rel="noopener noreferrer">
                    <motion.div
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      className="inline-flex items-center gap-2 px-5 py-3 bg-white/5 border border-white/10 rounded-full hover:border-nsdc-blue/30 hover:bg-nsdc-blue/5 transition-all"
                    >
          ...
          >
            ...
            <Link href="/events">
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="inline-flex items-center gap-3 px-8 py-4 border border-white/20 text-[var(--foreground)] font-medium rounded-full hover:border-nsdc-blue/50 hover:bg-nsdc-blue/5 transition-all"
              >
      ...
      <motion.button
        ...
        onClick={scrollToTop}
        className="fixed bottom-8 right-8 z-50 w-12 h-12 bg-nsdc-blue/90 rounded-full flex items-center justify-center shadow-lg hover:bg-nsdc-blue transition-colors"
      >
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-6">
        <Icon className="w-5 h-5 text-nsdc-blue/60" />
        <h2
