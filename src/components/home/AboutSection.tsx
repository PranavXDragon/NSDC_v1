...
const cards = [
  {
    ...
    subtitle: "COMMUNITY",
    description:
      "A student-driven community bringing together curious learners interested in Data Science, AI, Machine Learning, and technology.",
    stats: { value: "NEW", label: "CHAPTER" },
  ...
  },
  {
    ...
    subtitle: "LEARNING",
    description:
      "From Data Science and AI to Machine Learning and emerging technologies, we learn through workshops, projects, and hands-on experiences.",
    stats: { value: "4", label: "FOCUS AREAS" },
  ...
  },
  {
    ...
    subtitle: "PURPOSE",
    description:
      "We believe in learning by doing—turning curiosity into practical skills, ideas into projects, and students into confident builders.",
    stats: { value: "LEARN", label: "• BUILD • CONNECT" },
  ...
  },
  {
    ...
    subtitle: "FUTURE",
    description:
      "Building an inclusive student ecosystem where members collaborate, experiment, compete, and grow together.",
    stats: { value: "EST.", label: "2026 CHAPTER" },
...
function SimpleCard({ card, index }: { card: typeof cards[0]; index: number }) {
  ...
  return (
    ...
    >
      <div className="relative h-full overflow-hidden bg-[var(--surface)] border border-white/5 p-8 md:p-10 transition-all duration-300 hover:border-nsdc-blue/20">
        {/* Background Image */}
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt={card.title}
            fill
            className="object-cover opacity-30 grayscale group-hover:grayscale-0 group-hover:scale-105 group-hover:opacity-50 transition-all duration-500"
          />
          <div className="absolute inset-0 bg-black/50 group-hover:bg-black/40 transition-colors duration-500" />
          <div className="absolute inset-0 bg-gradient-to-b from-[var(--surface)]/95 via-[var(--surface)]/60 to-[var(--surface)]/95" />
        </div>

        {/* Top Accent Line */}
        <div className="absolute top-0 left-0 right-0 h-px bg-linear-to-r from-transparent via-nsdc-blue/30 to-transparent z-20" />
        ...
        <div className="relative z-10">
          {/* Subtitle */}
          <span
            className="text-[10px] font-medium tracking-[0.4em] text-nsdc-blue/70 uppercase"
...
export default function AboutSection() {
  ...
  return (
    ...
    >
      {/* Ambient Glow */}
      <div className="absolute top-1/3 left-1/4 w-[500px] h-[500px] rounded-full bg-nsdc-blue/2 blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div ref={headerRef} className="mb-12 sm:mb-16 md:mb-24">
          ...
          <div className="mt-10 md:mt-16 grid md:grid-cols-2 gap-8 md:gap-16">
            <motion.p
              ...
              style={{ fontFamily: "var(--font-body)" }}
            >
              <strong className="text-[var(--foreground)] font-medium">Where curiosity meets technology.</strong> We&apos;re creating a space for students to learn, build, collaborate, and grow.
            </motion.p>
            ...
            >
              ...
              <p className="text-lg md:text-xl font-light text-white/40 leading-[1.6]" style={{ fontFamily: "var(--font-body)" }}>
                ...
                {" "}and{" "}
                <span className="text-nsdc-blue font-medium">innovators</span>.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        >
          <Link
            href="/about"
            className="group flex items-center gap-3 px-8 py-4 border border-white/10 hover:border-nsdc-blue/50 bg-white/2 hover:bg-nsdc-blue/5 transition-all duration-300"
          >
            <span
            ...
            <ArrowRight className="w-4 h-4 text-nsdc-blue transition-transform duration-300 group-hover:translate-x-1" />
          </Link>
        </motion.div>
      </div>
    </section>
