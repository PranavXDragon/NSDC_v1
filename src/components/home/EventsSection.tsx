...
const pastEvents = eventsData.slice(0, 6);
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="relative aspect-square lg:aspect-auto lg:min-h-[500px] bg-linear-to-br from-[#0d1117] to-[#080808] overflow-hidden">
          ...
          {/* Badge */}
          <div className="absolute top-6 left-6 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-500/90 z-10">
        ...
        <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center">
          ...
          {event.registrationLink && event.registrationLink !== "#" ? (
            <a
              ...
              className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-nsdc-blue text-[var(--foreground)] font-semibold text-sm uppercase tracking-wider transition-all duration-300 hover:bg-nsdc-blue/90"
              style={{ fontFamily: "var(--font-body)" }}
            >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div
                className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30 text-green-400 font-semibold text-sm uppercase tracking-wider"
                style={{ fontFamily: "var(--font-body)" }}
              >
              ...
              {event.websiteLink && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-3 px-8 py-4 border border-nsdc-blue/40 text-nsdc-blue font-semibold text-sm uppercase tracking-wider transition-all duration-300 hover:border-nsdc-blue hover:bg-nsdc-blue/10"
                  style={{ fontFamily: "var(--font-body)" }}
                >
      ...
      >
        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-3 mb-4">
            <span className="text-nsdc-blue text-xs font-medium tracking-wider" style={{ fontFamily: "var(--font-body)" }}>
              {String(index + 1).padStart(2, '0')}
            </span>
          </div>
          
          {/* Title */}
          <h3 className="text-xl md:text-2xl font-black text-[var(--foreground)] mb-3 tracking-normal group-hover:text-nsdc-blue transition-colors" style={{ fontFamily: "var(--font-heading)" }}>
            {event.title}
          </h3>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 mb-4">
        ...
        <span className={`text-[10px] tracking-[0.4em] uppercase ${isUpcoming ? 'text-nsdc-blue' : 'text-white/30'}`} style={{ fontFamily: "var(--font-body)" }}>
          {subtitle}
        </span>
      </div>
...
export default function EventsSection() {
  return (
    ...
    >
      {/* Background Glow */}
      <div className="absolute top-1/4 -left-1/4 w-1/2 h-1/2 bg-nsdc-blue/3 rounded-full blur-[150px] pointer-events-none" />
      
      <div className="relative z-10 px-6 md:px-12 lg:px-20">
        <div className="max-w-[1400px] mx-auto">
          {/* Upcoming Events */}
          <SectionHeader title="Start Building" subtitle="Upcoming" isUpcoming />
          ...
          {/* The First Steps */}
          <SectionHeader title="The First Steps" subtitle="Our Beginning" />
