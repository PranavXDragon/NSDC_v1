...
export default function MarqueeSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-linear-to-b from-transparent via-nsdc-blue/2 to-transparent pointer-events-none" />
      ...
      {/* Second Marquee Row - Solid NSDC Blue */}
      <div className="relative overflow-hidden">
        ...
        >
          {Array.from({ length: repeatCount }).map((_, i) => (
            <span
              key={`row2-${i}`}
              className="text-[16vw] sm:text-[14vw] md:text-[11vw] font-black leading-[0.85] tracking-normal text-nsdc-blue"
              style={{
                fontFamily: "var(--font-heading)",
              }}
            >
              {marqueeText}
              <span className="mx-4 sm:mx-8 text-nsdc-blue/30">—</span>
            </span>
          ))}
        </motion.div>
      </div>
