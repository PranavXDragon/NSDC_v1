  ...
  return (
    <section className="relative bg-[#030303] py-20 sm:py-32 md:py-40 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 right-0 w-[500px] h-[500px] bg-nsdc-blue/[0.02] rounded-full blur-[200px]" />
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8">
            ...
            >
              EXPLORE THE <span className="text-nsdc-blue">ARCHIVE</span>
            </h2>
            ...
            {categories.map((category) => (
              <button
                ...
                className={`relative px-4 md:px-5 py-2 md:py-2.5 text-xs uppercase tracking-[0.15em] transition-all duration-300 border ${activeCategory === category
                  ? "bg-nsdc-blue/20 border-nsdc-blue/40 text-nsdc-blue"
              ...
              >
                {activeCategory === category && (
                  <motion.div
                    ...
                    className="absolute inset-0 bg-nsdc-blue/10 border border-nsdc-blue/30"
...
function BlogCard({
  ...
  return (
    ...
    >
      <div className="relative h-full flex flex-col bg-[var(--surface)] border border-white/5 overflow-hidden transition-all duration-500 hover:border-nsdc-blue/20">
        {/* Corner Accents */}
        ...
        <div className="absolute top-0 right-0 w-6 h-6 border-r-2 border-t-2 border-white/10 group-hover:border-nsdc-blue/40 transition-colors duration-500 z-10" />
        <div className="absolute bottom-0 left-0 w-6 h-6 border-l-2 border-b-2 border-white/10 group-hover:border-nsdc-blue/40 transition-colors duration-500 z-10" />
        ...
        <div className="p-5 md:p-6 flex-1 flex flex-col">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-white/5 mt-auto">
            ...
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 rounded-full bg-linear-to-br from-nsdc-blue/30 to-nsdc-blue/10 border border-white/10 flex items-center justify-center">
          ...
          <motion.div
            className="absolute bottom-5 right-5 flex items-center gap-2 text-nsdc-blue"
