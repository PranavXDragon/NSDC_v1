  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <motion.div
          style={{ opacity }}
          className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-nsdc-blue/[0.04] rounded-full blur-[200px]"
        />
        
        {/* Vertical line */}
        <div className="absolute left-1/2 top-0 -translate-x-1/2 w-px h-full">
          <motion.div
            className="h-full w-full bg-linear-to-b from-transparent via-nsdc-blue/20 to-transparent"
      ...
      >
        ...
        >
          <div className="relative w-20 h-20">
            ...
            {/* Middle ring */}
            <motion.div
              className="absolute inset-2 border border-nsdc-blue/20 rounded-full"
              animate={{ rotate: -360 }}
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-3 h-3 bg-nsdc-blue/40 rounded-full" />
            </div>
            
            {/* Orbiting dot */}
            <motion.div
              className="absolute w-2 h-2 bg-nsdc-blue rounded-full"
              style={{
                top: "50%",
                left: "50%",
                marginTop: "-4px",
        ...
        >
          <span 
            className="text-8xl md:text-9xl font-black text-nsdc-blue/10 leading-none select-none"
        ...
        >
          ...
          >
            ...
            >
              WINDOW
              <motion.span
                className="absolute -bottom-1 left-0 right-0 h-px bg-nsdc-blue/40 block"
                initial={{ scaleX: 0 }}
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8, delay: 0.8 }}
          className="mt-16 w-px h-24 bg-linear-to-b from-nsdc-blue/40 to-transparent origin-top"
        />
      </motion.div>
    </section>
  );
