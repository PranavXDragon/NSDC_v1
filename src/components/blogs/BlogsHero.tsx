      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        ...
        >
          <div className="max-w-[1400px] mx-auto w-full">
            ...
            >
              Ideas, insights, and experiences from the NSDC SCET community — covering technology, innovation, projects, and student journeys.
            </motion.p>
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm font-medium text-white">AI &middot; DATA &middot; WEB &middot; TECH</p>
              </div>
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm font-medium text-white">NSDC Community</p>
              </div>
              ...
              >
                <div className="flex flex-col items-center gap-2">
                  ...
                  <div className="h-12 w-px bg-linear-to-b from-nsdc-blue to-transparent" />
                </div>
              </motion.div>
            </motion.div>
          </div>
