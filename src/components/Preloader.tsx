            ...
            {!isExiting && (
                ...
                >
                    <div className="flex flex-col items-center gap-4">
                        <span className="text-xs text-nsdc-blue tracking-[0.3em] uppercase animate-pulse">
                            System Initialization
                        </span>

                        <div suppressHydrationWarning className="text-8xl font-black tracking-tighter tabular-nums text-white">
                            {mounted ? count.toString().padStart(3, '0') : '000'}
                        </div>

                        <div className="h-[2px] w-32 bg-white/20 overflow-hidden relative">
                            <motion.div
                                className="absolute left-0 top-0 h-full bg-nsdc-blue"
                                initial={{ width: 0 }}
                                animate={{ width: `${count}%` }}
                            />
                        </div>
