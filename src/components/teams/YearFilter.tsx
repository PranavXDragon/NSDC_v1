...
const years: { value: TeamYear; label: string; badge?: string }[] = [
  { value: "2026-27", label: "2026-27", badge: "Current" },
];
    ...
    <div className="relative z-20 max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20 py-8 md:py-12">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-4">
          <div className="w-12 md:w-16 h-px bg-linear-to-r from-nsdc-blue/60 to-transparent" />
          <span
            ...
            >
              ...
              {selectedYear === year.value && (
                <motion.div
                  ...
                  className="absolute inset-0 bg-nsdc-blue/20 border border-nsdc-blue/30"
              ...
              <span className="relative z-10 flex items-center gap-2">
                ...
                {year.badge && selectedYear === year.value && (
                  <motion.span
                    ...
                    animate={{ opacity: 1, scale: 1 }}
                    className="px-2 py-0.5 text-[9px] tracking-[0.15em] uppercase bg-nsdc-blue/30 text-nsdc-blue border border-nsdc-blue/40"
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    {year.badge}
                  </motion.span>
