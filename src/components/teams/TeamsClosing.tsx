  ...
  return (
    <section className="relative w-full bg-[#030303] overflow-hidden py-32 md:py-40">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-nsdc-blue/5 rounded-full blur-[200px]" />
      </div>
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <motion.p
            ...
            style={{ fontFamily: "var(--font-body)" }}
          >
            We&apos;re building the NSDC SCET community from the ground up. Whether you&apos;re interested in technology, design, events, research, or innovation — there&apos;s a place for you here.
          </motion.p>
          ...
          >
            <Link
              href="https://www.nsdc.org/membership/join"
              target="_blank"
              rel="noopener noreferrer"
              className="group relative px-8 py-4 bg-nsdc-blue hover:bg-nsdc-blue/90 transition-all duration-300 overflow-hidden"
            >
              <span 
            ...
            <Link
              href="/about"
              className="group px-8 py-4 border border-white/10 hover:border-nsdc-blue/50 bg-white/2 hover:bg-white/5 transition-all duration-300"
            >
              <span 
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="text-nsdc-blue text-lg opacity-60">✦</div>
