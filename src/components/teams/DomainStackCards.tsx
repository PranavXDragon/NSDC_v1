...
function DomainCard({ domain, index }: { domain: DomainProps; index: number }) {
  ...
  return (
    ...
    >
      <div className="relative bg-[var(--surface)] border border-white/5 p-6 md:p-8 transition-all duration-500 hover:border-nsdc-blue/30 overflow-hidden">
        {/* Corner Accents */}
        <div className="absolute top-0 left-0 w-4 h-4 border-l border-t border-white/10 group-hover:border-nsdc-blue/40 transition-colors duration-300" />
        <div className="absolute top-0 right-0 w-4 h-4 border-r border-t border-white/10 group-hover:border-nsdc-blue/40 transition-colors duration-300" />
        <div className="absolute bottom-0 left-0 w-4 h-4 border-l border-b border-white/10 group-hover:border-nsdc-blue/40 transition-colors duration-300" />
        <div className="absolute bottom-0 right-0 w-4 h-4 border-r border-b border-white/10 group-hover:border-nsdc-blue/40 transition-colors duration-300" />

        {/* Background Number */}
        <div className="absolute top-4 right-4 select-none pointer-events-none">
          <span 
            className="text-6xl md:text-7xl font-black text-white/3 group-hover:text-nsdc-blue/10 transition-colors duration-500"
        ...
        <div className="relative mb-6">
          <div className="w-12 h-12 flex items-center justify-center bg-white/5 border border-white/10 group-hover:border-nsdc-blue/30 group-hover:bg-nsdc-blue/10 transition-all duration-300">
            <Icon className="w-5 h-5 text-white/50 group-hover:text-nsdc-blue transition-colors duration-300" strokeWidth={1.5} />
          </div>
        </div>
        ...
        <div className="relative">
          <h4 
            className="text-xl md:text-2xl font-black text-[var(--foreground)] mb-3 tracking-normal group-hover:text-nsdc-blue transition-colors duration-300"
            style={{ fontFamily: "var(--font-heading)" }}
          >
            {domain.title}
          </h4>
        ...
        {/* Bottom Accent Line */}
        <motion.div
          className="absolute bottom-0 left-0 h-0.5 bg-nsdc-blue/50"
          initial={{ width: 0 }}
        ...
        {/* Hover Glow */}
        <div className="absolute inset-0 bg-nsdc-blue/0 group-hover:bg-nsdc-blue/3 transition-colors duration-500 pointer-events-none" />
      </div>
    </motion.div>
  );
}
  ...
  return (
    <section className="relative w-full bg-[#030303] overflow-hidden py-24 md:py-32">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-nsdc-blue/5 rounded-full blur-[200px]" />
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="mb-16 md:mb-20">
          ...
          <motion.h2
            ...
            style={{ fontFamily: "var(--font-heading)" }}
          >
            OUR <span className="text-nsdc-blue">DOMAINS</span>
          </motion.h2>
