      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <motion.div
            ...
            className="absolute top-1/3 left-1/2 -translate-x-1/2 h-[500px] w-[500px] rounded-full bg-foreground/2 blur-[100px]"
          />
        </div>
        ...
        >
          <div className="max-w-[1400px] mx-auto w-full">
            ...
            >
              The people building the foundation of NSDC SCET.
            </motion.p>
