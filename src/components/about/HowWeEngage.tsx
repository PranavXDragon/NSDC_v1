...
const engagements = [
  {
    ...
    icon: GraduationCap,
    gradient: "from-blue-600 to-nsdc-blue",
  },
  {
    title: "Build",
    ...
    icon: Rocket,
    gradient: "from-nsdc-blue to-purple-600",
  },
  {
    title: "Connect",
...
function EngagementCard({
  ...
  return (
    <motion.div
      ...
      className="group relative rounded-2xl border border-[var(--border)] bg-linear-to-br from-gray-900/50 to-[var(--background)] p-6 backdrop-blur-sm transition-all duration-500 hover:border-nsdc-blue/50 md:rounded-3xl md:p-8"
    >
      <div
      ...
      <div className="relative z-10">
        ...
        <div className="mb-4 md:mb-6">
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-linear-to-br from-gray-800 to-gray-900 transition-transform duration-300 group-hover:scale-110 md:h-16 md:w-16 md:rounded-2xl">
            <Icon
              className="h-6 w-6 text-nsdc-blue md:h-8 md:w-8"
              strokeWidth={1.5}
            />
          </div>
        </div>
        ...
        <div className="mb-4 md:mb-6">
          ...
          <p className="text-base font-medium text-nsdc-blue md:text-lg">
            {price}
          </p>
        </div>
        ...
        <ul className="space-y-2 md:space-y-3">
          {features.map((feature, idx) => (
            ...
            >
              <div className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-nsdc-blue md:mt-2" />
              <span>{feature}</span>
            </li>
          ))}
        </ul>
...
export default function HowWeEngage() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute left-1/4 top-1/2 h-64 w-64 rounded-full bg-nsdc-blue/5 blur-[100px] md:h-96 md:w-96 md:blur-[150px]" />
  ...
  return (
    <div className="md:hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="mb-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-linear-to-br from-gray-800 to-gray-900">
              <Icon className="h-6 w-6 text-nsdc-blue" strokeWidth={1.5} />
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <p className="text-sm font-medium text-nsdc-blue">
              {engagement.price}
            </p>
          </div>
          ...
          <ul className="space-y-2">
            {engagement.features.map((feature, idx) => (
              ...
              >
                <div className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-nsdc-blue" />
                <span>{feature}</span>
              </li>
            ))}
          </ul>
      ...
      <div className="mt-6 flex items-center justify-center gap-4">
        <button
          onClick={prevSlide}
          className="flex h-10 w-10 items-center justify-center rounded-full border border-[var(--border)] bg-[var(--surface)]/50 text-[var(--foreground)] transition-colors hover:border-nsdc-blue hover:bg-nsdc-blue/10"
        >
