...
const socialLinks = [
  {
    name: "Instagram",
    href: "https://instagram.com/usarnsdc",
    icon: Instagram
  },
  {
    name: "LinkedIn",
    href: "https://linkedin.com/company/usarnsdc",
    icon: Linkedin
  },
  {
    name: "YouTube",
    href: "https://www.youtube.com/@usarnsdc",
    icon: Youtube
  },
  {
    name: "Email",
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-nsdc-blue/5 rounded-full blur-[200px]" />
      </div>
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20">
        <div ref={headerRef} className="text-center max-w-4xl mx-auto">
          ...
          >
            READY TO <span className="text-nsdc-blue">BUILD</span>
            <br />
          ...
          >
            <Link
              href="/teams"
              className="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-nsdc-blue text-[var(--foreground)] font-medium text-sm uppercase tracking-normalr transition-all duration-300 hover:bg-nsdc-blue/90"
              style={{ fontFamily: "var(--font-body)" }}
            >
          ...
          >
            {socialLinks.map((social, index) => (
              <a
                ...
                className="group p-3 border border-white/5 bg-white/2 transition-all duration-300 hover:border-nsdc-blue/30 hover:bg-nsdc-blue/5"
              >
                <social.icon className="w-5 h-5 text-white/40 group-hover:text-nsdc-blue transition-colors duration-300" />
              </a>
            ))}
          </motion.div>
          ...
          >
            ...
            <a
              href="mailto:demo_usarnsdc@ipu.ac.in"
              className="text-white/50 hover:text-nsdc-blue transition-colors duration-300"
            >
              demo usarnsdc@ipu.ac.in
            </a>
          </motion.p>
        </div>
      </div>
