...
const bridgeItems = [
  {
    ...
    title: "Technical",
    desc: "ML, Web Dev, DSA",
    color: "from-blue-600 to-nsdc-blue",
  },
  {
    icon: Palette,
    title: "Creative",
  ...
  },
  {
    ...
    title: "United",
    desc: "One Community",
    color: "from-nsdc-blue to-nsdc-blue-light",
  },
];
        ...
        >
          {bridgeItems.map((item, index) => (
            <motion.div
              ...
              className="group relative rounded-xl border border-[var(--border)] bg-[var(--surface)]/20 p-3 transition-all duration-500 hover:border-nsdc-blue/50 md:rounded-3xl md:p-8"
            >
              <div
              ...
              />
              <item.icon className="mx-auto mb-2 h-6 w-6 text-nsdc-blue transition-transform duration-300 group-hover:scale-110 md:mb-4 md:h-12 md:w-12" />
