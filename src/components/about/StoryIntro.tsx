...
const stats = [
  { icon: Users, label: "20+ Active Members" },
        ...
        >
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="flex flex-col items-center gap-2 rounded-xl border border-[var(--border)] bg-[var(--surface)]/20 p-3 backdrop-blur-sm transition-all duration-300 hover:border-nsdc-blue/30 hover:bg-[var(--surface)]/40 md:gap-4 md:rounded-2xl md:p-6"
            >
              <stat.icon
                className="h-5 w-5 text-nsdc-blue md:h-10 md:w-10"
                strokeWidth={1.5}
              />
