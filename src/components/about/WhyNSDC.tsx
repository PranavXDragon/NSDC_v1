...
export default function WhyNSDC() {
          ...
          {values.map((value, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-3xl border border-[var(--border)] bg-linear-to-br from-gray-900/30 to-[var(--background)] p-8 transition-all duration-500 hover:border-nsdc-blue/30"
              >
                <div className="absolute inset-0 bg-linear-to-br from-nsdc-blue/5 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />

                <div className="relative z-10">
                  <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl border border-[var(--border)] bg-[var(--surface)]/50 transition-all duration-300 group-hover:border-nsdc-blue/50 group-hover:bg-nsdc-blue/10">
                    <Icon className="h-7 w-7 text-nsdc-blue" strokeWidth={1.5} />
                  </div>
            ...
            {values.map((value, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative flex items-start gap-4 rounded-xl border border-[var(--border)] bg-[var(--surface)]/30 p-4 backdrop-blur-sm transition-all duration-300 hover:border-nsdc-blue/30"
                >
                  {/* Icon */}
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-[var(--border)] bg-[var(--surface)]/80">
                    <Icon className="h-5 w-5 text-nsdc-blue" strokeWidth={1.5} />
                  </div>
