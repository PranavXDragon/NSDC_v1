      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        ...
        >
          <div className="max-w-[1400px] mx-auto w-full">
            ...
            >
              Student-built projects, experiments, and innovations from the NSDC SCET community.
            </motion.p>
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm font-medium text-white">8 Founding Leads</p>
              </div>
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm font-medium text-white">AI &middot; Data &middot; Web &middot; Hardware</p>
              </div>
