    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <motion.div
          ...
          className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-nsdc-blue/10 blur-[200px]"
        />
        <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-purple-900/5 rounded-full blur-[150px]" />
        <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-nsdc-blue/5 rounded-full blur-[120px]" />
      </div>
      ...
      >
        ...
        >
          <div className="w-12 h-px bg-linear-to-r from-transparent to-nsdc-blue/50" />
          <span 
          ...
          <div className="w-12 h-px bg-linear-to-l from-transparent to-nsdc-blue/50" />
        </motion.div>
        ...
        <motion.div
          ...
          className="w-24 h-0.5 bg-linear-to-r from-transparent via-nsdc-blue to-transparent mx-auto mb-10"
        />
        ...
        >
          ...
          Whether you have an <span className="text-white/60">idea worth building</span> or want to 
          <span className="text-nsdc-blue"> collaborate</span>, bring it to NSDC SCET and build it with the community.
        </motion.p>
        ...
        >
          {/* Primary CTA */}
          <a
            href="mailto:demo_usarnsdc@ipu.ac.in"
            className="group relative px-8 py-4 bg-nsdc-blue hover:bg-nsdc-blue-light overflow-hidden transition-all duration-300"
          >
            {/* Shine Effect */}
          ...
          <a
            href="/teams"
            className="group px-8 py-4 border border-white/20 hover:border-nsdc-blue/50 bg-white/5 hover:bg-nsdc-blue/10 transition-all duration-300"
          >
            <span className="flex items-center gap-3">
              ...
              <ArrowUpRight className="w-4 h-4 text-white/50 group-hover:text-nsdc-blue transition-all group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
            </span>
          </a>
        </motion.div>
        ...
        >
          {[
            { value: "BUILD", label: "Projects by students" },
            { value: "LEARN", label: "Through real-world development" },
            { value: "COLLABORATE", label: "Across disciplines" },
          ].map((stat, i) => (
            <div key={i} className="text-center">
              <div 
                className="text-2xl md:text-4xl font-black text-[var(--foreground)] mb-2"
                style={{ fontFamily: "var(--font-heading)" }}
              >
                {stat.value}
              </div>
        ...
        >
          {[
            { icon: Linkedin, href: "https://linkedin.com/company/usarnsdc", label: "LinkedIn" },
            { icon: Mail, href: "mailto:demo_usarnsdc@ipu.ac.in", label: "Email" },
          ].map((social, i) => (
            <a
              key={i}
              href={social.href}
              ...
              className="group p-3 border border-white/10 hover:border-nsdc-blue/30 bg-white/5 hover:bg-nsdc-blue/10 transition-all duration-300"
              aria-label={social.label}
            >
              <social.icon className="w-5 h-5 text-white/40 group-hover:text-nsdc-blue transition-colors" />
            </a>
          ))}
        </motion.div>
      </motion.div>
