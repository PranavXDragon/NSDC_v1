...
export default function FeaturedDeepDive({ projects }: FeaturedDeepDiveProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-1/4 top-1/4 h-[300px] w-[300px] rounded-full bg-nsdc-blue/5 blur-[100px] md:h-[600px] md:w-[600px] md:blur-[150px]" />
      <div className="absolute bottom-1/4 right-1/4 h-[250px] w-[250px] rounded-full bg-nsdc-blue/3 blur-[100px] md:h-[500px] md:w-[500px] md:blur-[150px]" />
      ...
      <div className="relative z-10 px-4 md:px-12">
        ...
        >
          <div className="mb-4 flex items-center justify-center gap-3 md:mb-6 md:justify-start md:gap-4">
            <div className="h-px w-10 bg-nsdc-blue/50 md:w-16" />
            <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-nsdc-blue md:text-xs md:tracking-[0.4em]">
              Deep Dive
            </span>
            <div className="h-px w-10 bg-nsdc-blue/50 md:hidden" />
          </div>
    ...
    >
      ...
      >
        <div className="group relative overflow-hidden rounded-2xl md:rounded-3xl">
          ...
          <div className="absolute -inset-2 rounded-2xl bg-nsdc-blue/10 opacity-0 blur-xl transition-opacity duration-500 group-hover:opacity-100 md:-inset-4 md:rounded-3xl md:blur-2xl" />
      ...
      >
        ...
        <motion.p
          ...
          className="mt-1.5 text-sm text-nsdc-blue md:mt-2 md:text-lg"
        >
          {project.subtitle}
        </motion.p>
        ...
        >
          {project.metrics.slice(0, 3).map((metric) => (
            <div
              key={metric}
              className="border-l-2 border-nsdc-blue/30 pl-2 md:pl-4"
            >
        ...
        {project.link && (
          ...
          >
            <a
              ...
              className="group inline-flex items-center gap-2 font-mono text-xs uppercase tracking-normalr text-[var(--foreground)] transition-colors hover:text-nsdc-blue md:gap-3 md:text-sm"
            >
              <span>View Project</span>
              <span className="relative h-px w-8 bg-white/30 transition-all group-hover:w-12 group-hover:bg-nsdc-blue md:w-10 md:group-hover:w-16">
                <span className="absolute -top-[5px] right-0 text-white/50 transition-colors group-hover:text-nsdc-blue">
                  →
                </span>
              </span>
            </a>
