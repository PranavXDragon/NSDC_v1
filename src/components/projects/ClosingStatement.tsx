  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute left-1/2 top-1/2 h-[300px] w-[300px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-nsdc-blue/10 blur-[100px] will-change-transform md:h-[600px] md:w-[600px] md:blur-[150px]"
      />
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="mb-6 h-px bg-nsdc-blue/50 md:mb-8"
          style={{ width: "100px" }}
        />
        ...
        <motion.span
          ...
          className="mb-4 font-mono text-[10px] uppercase tracking-[0.3em] text-nsdc-blue md:mb-6 md:text-xs md:tracking-[0.5em]"
        >
          Join The Movement
        </motion.span>
        ...
        >
          ...
          <br />
          <span className="text-nsdc-blue">Something Extraordinary?</span>
        </motion.h2>
        ...
        >
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="group relative overflow-hidden rounded-full bg-nsdc-blue px-8 py-3.5 text-center font-medium text-[var(--foreground)] shadow-lg shadow-nsdc-blue/20 transition-all hover:bg-nsdc-blue-light hover:shadow-xl hover:shadow-nsdc-blue/30 md:px-10 md:py-4"
          >
