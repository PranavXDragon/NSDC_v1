    ...
    <section ref={containerRef} className="relative h-[110vh] overflow-hidden">
      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        ...
        >
          ...
          >
            <span className="h-px w-8 bg-nsdc-blue/50 md:w-12" />
          ...
          <div className="overflow-hidden">
            ...
            >
              ...
              <span className="block text-nsdc-blue">breathe.</span>
            </motion.h1>
          </div>
          ...
          >
            ...
            >
              ...
              <div className="h-8 w-px bg-nsdc-blue/30 md:h-12" />
            </motion.div>
          </motion.div>
        </motion.div>
      </div>
  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      {particles.map((p) => (
        <motion.div
          key={p.id}
          className="absolute rounded-full bg-nsdc-blue/30 will-change-transform"
          style={{
            left: `${p.x}%`,
            top: `${p.y}%`,
            width: p.size,
