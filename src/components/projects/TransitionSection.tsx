...
function MobileTransitionSection() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute left-1/2 top-1/3 h-40 w-40 -translate-x-1/2 rounded-full bg-nsdc-blue/20 blur-[80px]" />
      ...
      <div className="relative z-10 px-5">
        ...
        <div className="mb-8 text-center">
          <motion.div
            ...
            className="mx-auto mb-4 h-0.5 bg-nsdc-blue"
          />
          <motion.p
            ...
            className="font-mono text-[10px] uppercase tracking-[0.3em] text-nsdc-blue"
          >
            Continuum
          </motion.p>
          <motion.h2
        ...
        <div className="mb-8 grid grid-cols-3 gap-2 px-1">
          {stats.map((stat, index) => (
            ...
            >
              <span className="absolute -top-1.5 -right-0.5 text-sm text-nsdc-blue/40">
                {stat.icon}
              </span>
        ...
        >
          <div className="mb-3 flex items-center gap-2">
            <div className="h-2 w-2 rounded-full bg-nsdc-blue" />
        ...
        <div className="space-y-3">
          {features.map((item, index) => (
            ...
            >
              {/* Icon badge */}
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-nsdc-blue/10 text-sm text-nsdc-blue">
                {item.icon}
              </div>
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="absolute inset-0"
      >
        <div className="absolute left-1/2 top-0 h-64 w-64 -translate-x-1/2 rounded-full bg-nsdc-blue/10 blur-[120px]" />
        ...
        <div className="grid gap-10 lg:grid-cols-[3fr_2fr] lg:items-center">
          <div>
            <motion.p
              ...
              viewport={{ once: false, amount: 0.6 }}
              transition={{ duration: 0.6 }}
              className="font-mono text-xs uppercase tracking-[0.4em] text-nsdc-blue"
            >
              Continuum
            </motion.p>
            <motion.h2
