        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div className="flex flex-col justify-center">
              <ScrollWords
                text="TESSERACT is a Web3 hackathon hosted by NSDC in collaboration with Hela Labs. Teams will build real-world projects deployed on the Hela blockchain, competing for prizes worth ₹50,000+ and ecosystem access."
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                details: ["Live project demonstration", "Industry judge panel", "On-campus at NSDC SCET", "Prizes, swags & recognition"],
                highlight: false,
              },
            ].map((round, i) => (
              <motion.div
      ...
      <section id="prizes" className="relative z-10 w-full py-24 md:py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20">
          ...
          <motion.div
            ...
            transition={{ duration: 1, delay: 0.5, ease: EASE }}
          >
            {["NSDC merchandise & swag kits", "Certificates for all", "Industry mentor networking", "Hela Labs ecosystem access"].map((perk, i) => (
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: "₹50,000+ in cash prizes plus NSDC swag kits, certificates, mentorship opportunities, and exclusive access to the Hela Labs ecosystem for all participants."
              },
              {
                q: "Is accommodation provided?",
                a: "The hackathon is in-person at NSDC SCET. Accommodation is not provided, but we can help connect outstation participants with local resources."
              },
              {
