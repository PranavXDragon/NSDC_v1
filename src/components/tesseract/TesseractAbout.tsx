      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8">
          ...
          <div className="lg:col-span-9">
            <ScrollRevealText
              text="TESSERACT is the flagship hackathon by NSDC — a convergence of ideas, code, and blockchain innovation. In collaboration with Hela Labs, participants build and deploy real-world projects on the Hela L1 blockchain, pushing the boundaries of what's possible in decentralized technology."
