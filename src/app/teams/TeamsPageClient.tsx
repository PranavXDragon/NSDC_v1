...
export default function TeamsPageClient() {
    const [selectedYear, setSelectedYear] = useState<TeamYear>("2026-27");
        ...
        <main className="min-h-screen bg-[#030303] text-[var(--foreground)]">
            ...
            <div className="relative">
                ...
                <TeamSection
                    ...
                    subtitle="The Mentor"
                    description="Guiding and supporting the NSDC SCET chapter with academic direction, mentorship, and institutional support."
                    members={faculty}
                    sectionNumber="01"
                ...
                <TeamSection
                    ...
                    description="The founding leadership team responsible for building the NSDC SCET community, driving initiatives, and shaping the chapter's journey."
